# House example - Coincides with lesson 10
class House:
...
class Condo(House):
    ...
    # you only have to do the properties for the new stuff
    @property
    def balcony(self):
...
my_condo = Condo(10, 'clay', 'steel', 'white', 'large rail')
print('The condo has', my_condo.window_size, 'inch windows')
print('The condo has a', my_condo.balcony, 'balcony.')
